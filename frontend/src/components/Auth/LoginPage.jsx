...
import { Mail, Lock, ArrowRight, Loader2, Check, EyeOff } from 'lucide-react';
import './Auth.css';
...
export default function LoginPage({ onLogin, onSwitchToSignup }) {
  ...
  const handleEmailLogin = (e) => {
    e.preventDefault();
    setError('Email/Password login is not configured yet. Please use Google or GitHub.');
  };
      ...
      <div className="auth-container">
        <div className="auth-card scale-in fade-in">
          <div className="auth-header">
            ...
            <h2 className="auth-subtitle-main">Continue your data work with PipeWise-AI</h2>
            <p className="auth-subtitle-sub">Access your pipelines, models, and insights</p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="auth-form">
            <div className="form-group">
              ...
              <div className={`input-wrapper ${email.length > 0 ? 'has-value' : ''}`}>
                ...
                />
                <Check size={16} className="input-icon-right success-icon" />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                ...
                <EyeOff size={16} className="input-icon-right" />
              </div>
            </div>
